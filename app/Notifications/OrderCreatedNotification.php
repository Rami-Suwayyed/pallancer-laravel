...
class OrderCreatedNotification extends Notification
{
    ...
    {
        return ['mail', 'database', 'broadcast', /*'nexmo',*/ /*HotSms::class,*/ Releans::class]; // toMail, toDatabase, toBroadcast, toNexmo
...
//        return $via;
    ...
    public function toReleans($notifiable)
    {
        return 'A new order created.';
    }
